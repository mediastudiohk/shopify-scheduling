...
import {
    DeleteMajor} from '@shopify/polaris-icons';
import { styles } from "../../styles";
import { AREA_OPTIONS, CUSTOMER_TYPE_OPTIONS, DISTRICT_OPTIONS } from "../../constants/area";
import "../../css/dot-chasing.css";
import "../../css/tab-effect.css";
import "../../css/tab-sample.css";
import "react-datepicker/dist/react-datepicker.css";

export const Row = ({ rowData, rowIndex, dayIndex, setData, allData, handleDeleteRow, isPlacedOrders, day, isLoading, saveDay, dayData, isSavePress }) => {
    ...
    const getDistrictOption = (area) => {
        let districtCustomOption = DISTRICT_OPTIONS.find((item) => item.area === area)
        setDistrictCustom([...districtCustomOption.district,])
    }

    useEffect(async () => {
        (async () => {
            let districtCustomOption = DISTRICT_OPTIONS.find((item) => item.area === rowData.area)
            setDistrictCustom(districtCustomOption?.district)
        })();
    }, [])
